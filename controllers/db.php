  ...
  class db {
    ...
    public function showError($error, $array=null){
      ...
      if(isset($this->errors[$array][$error]['error'])){
        echo '<div style="color: #a80000; font-weight: bold; margin: 10px 0px; text-shadow: 0px 1px 2px #000;"><img src="images/error_icon.png" style="margin-right: 10px;"/>'.str_replace('_', ' ', $this->errors[$array][$error]['error']).'</div>';
      }
    }
